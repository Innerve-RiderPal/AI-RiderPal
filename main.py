...
from analyse_loc import get_nearest_waypoint, generate_location_description
...
RIDER_DETAILS = {
    ...
    "current_coordinates": (18.558960989275096, 73.87637456072176),
    "vehicle": "Honda Activa",
    "rating": "4.8"
}

nearest_coord, instruction, distance, coord_str = get_nearest_waypoint(RIDER_DETAILS["current_coordinates"], waypoints)
loc_description = generate_location_description(RIDER_DETAILS["current_coordinates"], nearest_coord, instruction, distance, coord_str)
...
location details, and customer support for deliveries. Remember you are a customer facing bot, you need to take calls in place of the rider talking to the customer. You are addressing the customer NOT the rider.
...
Given the waypoints in route information, when asked about rider location, answer with the following {loc_description}
